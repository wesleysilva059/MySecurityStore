...
<div class="cadastro_tela">
    <div class="container theme-showcase" role="main">
        <h3 class="form-signin-heading">Novo endereço</h3>      
        <br/>
        <div>
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#enderecoAlt" aria-controls="pessoa_fisica" role="tab" data-toggle="tab">Endereço</a></li>
            </ul>
            <div class="formulario">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="enderecoAlt">
                        <div style="padding-top:20px;">
                            <form action="cadastroendalternativo.php" method="POST" id="validate">  
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-1 col-sm-12">
                                        <button type="submit" value="Enviar" class="btn btn-success">Cadastrar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
