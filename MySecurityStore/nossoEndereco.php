		...
		<div class="col-sm-12">
			...
			<div class="painel">
	           			<div class="col-sm-6 text-center">
	               			<h3><i class="fa fa-map-marker"></i> Endereco</h3>
	                   		<p>Rua Aparecida Bulgari, Numero 75
	                        <br>
	                        Loteamento ACMA
	                        <br>
	                    ...
	                    <div class="col-sm-6 text-center">
                            <h3><i class="fa fa-whatsapp"></i> Contatos</h3>
                                <p><span class="fa fa-whatsapp" aria-hidden="true"></span> Claudio Maia - (35)98816-1903
			...
			<h2>Duvidas? Envie uma mensagem</h2>
