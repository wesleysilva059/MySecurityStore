		...
		function RetornaFornecedores(){
			...
			if ($vetfornecedores != null){
				...
				foreach ($vetfornecedores as $fornecedor) {
					...
					<a href="cadastraFornecedores.php?id='.$fornecedor['idfornecedor'].'"class="btn btn-primary">Alterar</a>
					<a href="excluir.php?id='.$fornecedor['idfornecedor'].'"class="btn btn-danger" onclick="return confirm(\'Deseja excluir?\');">Excluir</a>
					</td>
					</tr>';
				}
			}
