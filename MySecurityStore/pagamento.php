                    ...
                    <form method="POST">
                        <div class="col-sm-12 box">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="pull-right" name="Cartao1">Confirmar</button>
                        </div>
                    </form>
                <?php
                    if(isset($_POST['Cartao1'])){
                        if(isset($_POST["numerocartao"]) AND 
                ...
                <form method="POST">
                    <div class="col-sm-12 box">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="pull-right" name="Cartao2">Confirmar</button>
                    </div>
                </form>
                <?php
