...
-- Database: `bdsecurity`
--
CREATE DATABASE IF NOT EXISTS `bdsecurity` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bdsecurity`;
...
--
ALTER TABLE `pfisicacontatos`
  MODIFY `idpfcontato` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `pfisicadados`
--
ALTER TABLE `pfisicadados`
  MODIFY `idpfisica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `vendas`
  MODIFY `lancamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
